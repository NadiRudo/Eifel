...
Aufgelistet sind die verschiedenen Kapitel, um schnell zu dem Teil zu gelangen, der einen gerade interessiert.

[1. Herausforderungen der Löschwasserversorgung in Waldgebieten](#herausforderungen-der-löschwasserversorgung-in-waldgebieten)

[2. Wassertranzpport über lange Distanzen](#wassertransport-über-lange-distanzen)

[3. Zielsetzung der Untersuchunng](#zielsetzung-der-untersuchung)

[4. Datengrundlage und konzeptioneller Ansatz](#datengrundlage-und-konzeptioneller-ansatz)

[5. Löschabdeckung im Nationalpark Eifel](#löschabdeckung-im-nationalpark-eifel)

[6. Warum wirde eine Löschabdeckung benötigt?](#warum-wird-eine-löschabdeckung-benötigt)
...
## Löschabdeckung im Nationalpark Eifel

Die Analyse zeigt deutlich, dass die Löschwasserversorgung in großen Waldgebieten stark eingeschränkt sein kann (siehe Abb. 5).
...
## Warum wird eine Löschabdeckung benötigt?
...
Autoren: Nadine Rudolph und Alexandra Schmitz
